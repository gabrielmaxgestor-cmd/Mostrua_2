...
import { AlertCircle, ArrowLeft, Eye, EyeOff, Mail, Lock, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen lg:grid lg:grid-cols-2 bg-white relative font-sans">
      ...
      <div className="hidden lg:flex relative bg-gradient-to-br from-blue-600 to-blue-800 p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10">
          <img src="/logo.svg" alt="Mostrua Logo" className="h-10 brightness-0 invert mb-20" />
        ...
        <div className="w-full max-w-sm mx-auto">
              ...
              <div className="flex flex-col gap-1">
                {error === 'credenciais_invalidas' ? (
                  <>
                    ...
                    <Link to="/forgot-password" className="font-bold hover:underline inline-flex items-center gap-1">
                      Esqueceu sua senha? &rarr; Recuperar acesso
                    </Link>
                  </>
                ) : (
                  <span>{error}</span>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-orange-500 text-white font-bold rounded-xl hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/30 active:scale-[0.98] disabled:opacity-70 disabled:pointer-events-none flex items-center justify-center gap-2"
            >
