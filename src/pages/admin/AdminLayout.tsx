      ...
      <aside className="w-64 bg-[#0A0A0F] border-r border-white/5 p-6 flex flex-col fixed h-full z-20">
        ...
        <div className="pt-6 border-t border-white/5 mt-4">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-2.5 text-white/40 hover:bg-[#13131C] hover:text-red-400 rounded-xl font-medium transition-colors"
          >
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen">
        ...
        <header className="h-20 bg-[#13131C] border-b border-white/5 px-8 flex items-center justify-between sticky top-0 z-10">
          ...
          <div className="flex items-center gap-6">
            <Link to="/admin/notifications" className="relative text-white/50 hover:text-white/70 transition-colors">
